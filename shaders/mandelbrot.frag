...
void main() {
    ...
    float t = pow(iter / float(maxIterations), 0.3);

    // Map t to colorful HSV palette
    // Hue changes rapidly, saturation/value fixed
    vec3 color = hsv2rgb(vec3(0.95 + 10.0 * t, 0.6, 1.0));
